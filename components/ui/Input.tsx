...
const fieldBase =
  "w-full bg-zinc-900/80 backdrop-blur-sm border border-zinc-800 text-zinc-50 placeholder-zinc-500 rounded-md px-4 py-3 transition-colors duration-150 focus:outline-none focus:border-cyan-400 focus-visible:ring-2 focus-visible:ring-cyan-400/40 focus-visible:ring-offset-2 focus-visible:ring-offset-black";
