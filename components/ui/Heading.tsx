...
const styles: Record<HeadingVariant, string> = {
  h1: "font-jp font-bold text-[64px] md:text-[116px] leading-[0.92] md:leading-[0.88] text-zinc-50",
  h2: "font-jp font-bold text-3xl md:text-[42px] leading-none text-zinc-50",
  h3: "font-jp font-semibold text-xl md:text-2xl leading-tight text-zinc-50",
  eyebrow:
