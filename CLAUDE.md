...
> 上記 1〜3 は **1 PR で束ねる**（Phase as Single PR 原則）。すべて可逆タスク、不可逆要素なし。
...
8. Blue Sheep 公演に `venueUrl` or `venuePhone` 追加（v3 中優先度 #6）
